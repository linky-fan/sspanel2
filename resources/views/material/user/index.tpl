...
<p>&nbsp;Android<a href="https://github.com/shadowsocksr/shadowsocksr-android/releases"><i class="icon icon-lg">android</i>&nbsp;下载SSR客户端&nbsp;</a>，安装，然后点击<a id="android_add" href="{$android_add}">&nbsp;配置文件&nbsp;</a>导入客户端，然后选择一个合适的服务器即可上网。</p>
</div>
