										...
										<div class="card-table">
											...
											{$timebacks->render()}
												<table class="table">
													...
													<tbody>
													{foreach $timebacks as $timeback}
														<tr>
															<td><b>{$timeback->id}</b></td>
															<td><b>{$timeback->invite_code}</b></td>
															{if $timeback->user()!=null}
																<td>{$timeback->user()->user_name}
																</td>
																{else}
																<td>已注销
																</td>
