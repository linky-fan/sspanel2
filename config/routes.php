...
$app->get('/package', 'App\Controllers\HomeController:shop_package');
$app->get('/question', 'App\Controllers\HomeController:question');
$app->get('/question/{id}', 'App\Controllers\HomeController:questionByClassify');
...
$app->group('/user', function () {
    ...
    $this->post('/wx_pay', 'App\Controllers\UserController:wx_pay');
    $this->post('/edit_name', 'App\Controllers\UserController:edit_name');
    $this->post('/look_result', 'App\Controllers\UserController:look_result');
    ...
    $this->post('/withdrawal', 'App\Controllers\UserController:withdrawal');
...
$app->group('/admin', function () {
    ...
    $this->get('/create', 'App\Controllers\AdminController:create');
    $this->post('/add', 'App\Controllers\AdminController:add');
    $this->get('/{id}/edit', 'App\Controllers\AdminController:edit');
    $this->put('/edit/{id}', 'App\Controllers\AdminController:update');
    $this->delete('/delete', 'App\Controllers\AdminController:delete');
    $this->get('/question', 'App\Controllers\AdminController:question');
    $this->get('/question_create', 'App\Controllers\AdminController:question_create');
    $this->post('/question_add', 'App\Controllers\AdminController:question_add');
    $this->get('/{id}/question_edit', 'App\Controllers\AdminController:question_edit');
    $this->put('/question_edit/{id}', 'App\Controllers\AdminController:question_update');
    $this->delete('/question_delete', 'App\Controllers\AdminController:question_delete');
    $this->post('/package_ajax', 'App\Controllers\AdminController:package_ajax');
    $this->post('/question_ajax', 'App\Controllers\AdminController:question_ajax');
    ...
    $this->get('/code/withdrawal', 'App\Controllers\Admin\CodeController:withdrawal');
    $this->post('/code/sure_withdrawal', 'App\Controllers\Admin\CodeController:sure_withdrawal');
...
$app->group('/api', function () {
    ...
    $this->post('/wxpay_callback', 'App\Controllers\ApiController:wxpay_callback');
});
// mu
